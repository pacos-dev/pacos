package org.pacos.core.component.ai.view.config;
...
@Component
public class AIWindowConfig implements SettingTab {

    @Override
    public String getTitle() {
        return SettingTabName.AI.getName();
    }
    ...
    public boolean shouldBeDisplayed(UserSession userSession) {
        return userSession.hasPermission(SystemPermissions.AI_CONFIGURATION);
    }
